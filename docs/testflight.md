...
| Account deletion | The app currently describes completing deletion on the web but has no in-app initiation control. Add an approved flow before review; [Apple requires account-creating apps to offer deletion initiation in the app](https://developer.apple.com/support/offering-account-deletion-in-your-app/). |
